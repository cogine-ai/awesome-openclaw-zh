...
| [个人 CRM](../usecases/productivity/personal-crm.md) | 自动从电子邮件和日历中发现并追踪联系人，支持自然语言查询。 |
| [滚动式待办提醒系统](../usecases/productivity/rolling-todo-reminder.md) | 按优先级持续滚动提醒，降低待办遗漏。 |
| [活动嘉宾确认](../usecases/productivity/event-guest-confirmation.md) | 逐一呼叫活动嘉宾名单以确认出席、收集备注并编译摘要 —— 通过 AI 语音通话完全自动化。 |
...
| 用例 | 能干什么 |
|---|---|
| [1天冷启动付费社群流程](../usecases/research/one-day-paid-community-launch.md) | 从定位到执行的高密度冷启动运营打法。 |
| [个人知识库 (RAG)](../usecases/research/knowledge-base-rag.md) | 通过将 URL、推文和文章拖入聊天来构建可搜索的知识库。 |
| [全自动学习系统（Skills组合）](../usecases/research/skills-combo-auto-learning-system.md) | 把学习任务自动化，形成持续学习闭环。 |
...
| [生活记忆管理](../usecases/everyday/60-memory-life-logger.md) | 不再忘记生日、偏好和承诺 |
| [天气穿衣建议](../usecases/everyday/58-weather-outfit-advisor.md) | 基于天气和日程的穿搭建议 |
| [邮件通讯转播客](../usecases/everyday/51-email-to-podcast-commute.md) | 将通讯转为通勤音频 |
| [邮件自动分类](../usecases/everyday/56-email-auto-sorter.md) | 按紧急程度自动分类收件箱 |
| [预约预订助手](../usecases/everyday/63-booking-appointment-agent.md) | 不只找服务还直接预约 |
| [阅读清单管理](../usecases/everyday/61-reading-list-curator.md) | 整周保存链接周五获取摘要 |
...
| [自动社交发帖](../usecases/everyday/65-auto-social-posting.md) | 自动排期发布内容 |
| [作业辅导助手](../usecases/everyday/69-homework-tutor.md) | 耐心辅导引导而非直接给答案 |
...
| 用例 | 能干什么 |
|---|---|
| [安全操作分类账](../usecases/memory/42-safe-operations-ledger.md) | 记录自主权限 |
...
| [比特币铭文](../usecases/automation/15-bitcoin-inscription.md) | 在链上创建永久网页 |
...
| [夜间 WhatsApp 复兴](../usecases/automation/14-night-whatsapp-revival.md) | 回复消息，恢复冷淡友谊 |
...
| [令牌使用优化器](../usecases/security/27-token-usage-optimizer.md) | 降低 API 成本 |
...
| [API配额监控与提醒](../usecases/security/api-quota-monitor.md) | 自动检查模型配额与调用消耗，避免突发中断。 |

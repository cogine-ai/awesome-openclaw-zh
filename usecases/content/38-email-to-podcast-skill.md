...
```text
你是我的 OpenClaw 助手，现在执行案例「邮件转播客技能」。

目标（来自来源案例）：邮件音频转换的可重用技能
来源关键动作：# Email-to-Podcast Skill；## Introduction；Standalone OpenClaw skill that converts any email into podcast format. Reusable component for email audio conversion across domains.
优先工具/渠道：email、elevenlabs、ffmpeg、Gmail、OpenClaw
来源节奏信息：源头未明确固定调度
...
- [usecases/38-email-to-podcast-skill.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/38-email-to-podcast-skill.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「链上俳句铭文」。

目标（来自来源案例）：比特币上的加密诗歌
来源关键动作：# On-Chain Haiku Inscription；## Introduction；Creates artistic blockchain haikus during night shift. Combines crypto wisdom with blockchain permanence for creative expression.
优先工具/渠道：bitcoin、filesystem
来源节奏信息：源头未明确固定调度
...
- [usecases/44-on-chain-haiku-inscription.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/44-on-chain-haiku-inscription.md)

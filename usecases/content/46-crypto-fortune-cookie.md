...
```text
你是我的 OpenClaw 助手，现在执行案例「加密幸运饼干」。

目标（来自来源案例）：区块链上的交易智慧
来源关键动作：# Crypto Fortune Cookie；## Introduction；Generates crypto-themed fortune cookies with trading wisdom and inscribes them permanently on blockchain. Combines entertainment with education.
...
- [usecases/46-crypto-fortune-cookie.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/46-crypto-fortune-cookie.md)

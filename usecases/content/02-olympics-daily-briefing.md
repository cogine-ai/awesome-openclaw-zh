...
```text
你是我的 OpenClaw 助手，现在执行案例「奥运会每日简报」。

目标（来自来源案例）：体育赛事追踪与奖牌统计
来源关键动作：# Olympics Daily Briefing；## Introduction；**Why it matters**: Sports journalists and fans need curated, timely information without manually checking multiple sources.
优先工具/渠道：web_search、web_fetch、telegram、cron、Telegram
来源节奏信息：07:00；0 7 * * *
...
- [usecases/02-olympics-daily-briefing.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/02-olympics-daily-briefing.md)

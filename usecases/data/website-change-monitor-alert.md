...
```text
你是我的 OpenClaw 助手，现在执行案例「网站更新监控通知」。

目标（来自来源案例）：自动监控目标网站变化并在有更新时提醒。
来源关键动作：WEBSITE_URL="https://www.anthropic.com/news"；CACHE_FILE="$HOME/.openclaw/cache/website-monitor.txt"；OPENCLAW_BIN="openclaw"
...
- [examples/automation/website-monitor.sh](https://github.com/xianyu110/awesome-openclaw-tutorial/blob/main/examples/automation/website-monitor.sh)

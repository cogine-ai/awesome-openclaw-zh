...
### 风险与边界（来源提炼）
- Weekly preparation:
- Research latest CVEs
- Design 5 challenges per category
- Write solutions
...
```text
你是我的 OpenClaw 助手，现在执行案例「安全 CTF 课程」。

目标（来自来源案例）：培训挑战准备
来源关键动作：# Security CTF Curriculum；## Introduction；Automated capture-the-flag training preparation. Researches latest vulnerabilities, creates practice challenges, and tracks learning progress.
优先工具/渠道：web_search、filesystem
来源节奏信息：源头未明确固定调度
...
- [usecases/43-security-ctf-curriculum.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/43-security-ctf-curriculum.md)

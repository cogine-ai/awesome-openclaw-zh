...
```text
你是我的 OpenClaw 助手，现在执行案例「Pump.fun 扫描器」。

目标（来自来源案例）：新代币检测
来源关键动作：# Pump.fun Scanner；## Introduction；Automated new token detection on pump.fun with early market cap tracking. Identifies promising new launches for research or trading opportunities.
...
- [usecases/24-pump-fun-scanner.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/24-pump-fun-scanner.md)

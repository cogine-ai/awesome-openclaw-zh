...
```text
你是我的 OpenClaw 助手，现在执行案例「GitHub 陈旧问题清理」。

目标（来自来源案例）：识别关闭候选
来源关键动作：# GitHub Stale Issue Cleanup；## Introduction；Weekly identification and reporting of stale GitHub issues with no activity for >30 days. Suggests closure candidates and generates report for human review.
优先工具/渠道：github、GitHub
来源节奏信息：源头未明确固定调度
...
- [usecases/17-github-stale-issue-cleanup.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/17-github-stale-issue-cleanup.md)

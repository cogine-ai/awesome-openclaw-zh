...
```text
你是我的 OpenClaw 助手，现在执行案例「X 个人资料抓取器」。

目标（来自来源案例）：社交媒体数据收集
来源关键动作：# X Profile Scraper；## Introduction；Automated collection and archival of X (Twitter) user profiles and linked web content. Captures profile metadata, recent posts, and expanded link content for research, lead generation, or competitive analysis.
优先工具/渠道：web_fetch、web_search、csv、filesystem、config/x-targets.json、cron
来源节奏信息：06:00；0 6 * * *
...
- [usecases/08-x-profile-scraper.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/08-x-profile-scraper.md)

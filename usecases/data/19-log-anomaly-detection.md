...
```text
你是我的 OpenClaw 助手，现在执行案例「日志异常检测」。

目标（来自来源案例）：统计错误检测
来源关键动作：# Log Anomaly Detection；## Introduction；Automated log file scanning for error patterns, unusual activity, or security events. Identifies anomalies without predefined rules using statistical analysis.
...
- [usecases/19-log-anomaly-detection.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/19-log-anomaly-detection.md)

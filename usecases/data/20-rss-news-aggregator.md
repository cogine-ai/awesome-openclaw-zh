...
```text
你是我的 OpenClaw 助手，现在执行案例「RSS 新闻聚合器」。

目标（来自来源案例）：多源新闻去重
来源关键动作：# RSS News Aggregator；## Introduction；Multi-source RSS feed aggregation with deduplication and summarization. Combines multiple news sources, removes duplicates, and generates concise daily briefings.
优先工具/渠道：web_fetch、telegram、Telegram
来源节奏信息：Every 4 hours
...
- [usecases/20-rss-news-aggregator.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/20-rss-news-aggregator.md)

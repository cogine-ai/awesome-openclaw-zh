...
```text
你是我的 OpenClaw 助手，现在执行案例「每日AI行业日报推送」。

目标（来自来源案例）：每天定时推送 AI 行业动态，快速掌握最新趋势。
来源关键动作：OPENCLAW_BIN="openclaw"；CHANNEL="feishu"  # 或 telegram, wecom, dingtalk；LOG_FILE="$HOME/.openclaw/logs/daily-report.log"
...
- [examples/automation/daily-report.sh](https://github.com/xianyu110/awesome-openclaw-tutorial/blob/main/examples/automation/daily-report.sh)

...
```text
你是我的 OpenClaw 助手，现在执行案例「令牌使用优化器」。

目标（来自来源案例）：降低 API 成本
来源关键动作：# Token Usage Optimizer；## Introduction；Monitors and optimizes API token consumption during heartbeats. Identifies redundant checks and implements differential polling to reduce costs.
...
- [usecases/27-token-usage-optimizer.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/27-token-usage-optimizer.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「Git 历史清理器」。

目标（来自来源案例）：从历史中删除机密
来源关键动作：# Git History Cleaner；## Introduction；Removes sensitive data (API keys, passwords) from git history using filter-branch or BFG Repo-Cleaner. Fixes accidental commits of secrets.
优先工具/渠道：git
来源节奏信息：源头未明确固定调度
...
- [usecases/33-git-history-cleaner.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/33-git-history-cleaner.md)

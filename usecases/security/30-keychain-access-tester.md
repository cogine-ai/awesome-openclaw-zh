...
```text
你是我的 OpenClaw 助手，现在执行案例「钥匙串访问测试器」。

目标（来自来源案例）：测试人类安全意识
来源关键动作：# Keychain Access Tester；## Introduction；Tests macOS Keychain security by triggering password dialogs and monitoring human response. Identifies social engineering vulnerabilities in human-agent trust model.
优先工具/渠道：system、memory
来源节奏信息：源头未明确固定调度
...
- [usecases/30-keychain-access-tester.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/30-keychain-access-tester.md)

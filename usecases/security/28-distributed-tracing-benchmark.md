...
```text
你是我的 OpenClaw 助手，现在执行案例「分布式追踪基准测试」。

目标（来自来源案例）：可观察性开销测试
来源关键动作：# Distributed Tracing Benchmark；## Introduction；Benchmarks observability overhead in production agent meshes. Compares OpenTelemetry, Jaeger, and custom tracers to optimize telemetry costs.
优先工具/渠道：system、docker
来源节奏信息：源头未明确固定调度
...
- [usecases/28-distributed-tracing-benchmark.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/28-distributed-tracing-benchmark.md)

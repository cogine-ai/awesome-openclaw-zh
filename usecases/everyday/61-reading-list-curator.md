...
```text
你是我的 OpenClaw 助手，现在执行案例「阅读清单管理」。

目标（来自来源案例）：整周保存链接周五获取摘要
来源关键动作：Telegram or Signal connected to OpenClaw
...
- [usecases/61-reading-list-curator.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/61-reading-list-curator.md)

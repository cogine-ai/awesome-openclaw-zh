...
```text
你是我的 OpenClaw 助手，现在执行案例「旅行行程规划」。

目标（来自来源案例）：一条消息生成完整行程
来源关键动作：Telegram bot connected to OpenClaw；Your travel preferences
...
- [usecases/70-travel-itinerary-planner.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/70-travel-itinerary-planner.md)

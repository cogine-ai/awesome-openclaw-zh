...
```text
你是我的 OpenClaw 助手，现在执行案例「自动社交发帖」。

目标（来自来源案例）：自动排期发布内容
来源关键动作：Social media accounts (X/Twitter, LinkedIn, etc.)；Telegram bot for review/approval；Browser capability in OpenClaw
优先工具/渠道：Telegram、cron、OpenClaw
来源节奏信息：8:30；12:30；9:00
...
- [usecases/65-auto-social-posting.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/65-auto-social-posting.md)

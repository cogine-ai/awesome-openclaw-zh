...
- **Telegram Bot**: To receive daily prompts and send your responses
- **Storage Location**: A folder path for saving journal entries
- **Your Learning Goals**: What skills or areas you're currently focusing on
- **Preferred Time**: When you want to receive the daily prompt (evening recommended)
- **Journal Format**: Whether you prefer short answers or longer reflections
...
```text
你是我的 OpenClaw 助手，现在执行案例「每日学习日记」。

目标（来自来源案例）：晚间问答追踪个人成长
来源关键动作：Before you begin, make sure you have:；**Telegram Bot**: To receive daily prompts and send your responses；**Storage Location**: A folder path for saving journal entries
优先工具/渠道：Telegram、cron
来源节奏信息：8:00；7:00；9:30；0 20 * * *
...
- [usecases/57-daily-learning-journal.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/57-daily-learning-journal.md)

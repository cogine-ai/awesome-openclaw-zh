...
```text
你是我的 OpenClaw 助手，现在执行案例「Instagram 故事管理」。

目标（来自来源案例）：自动发布故事并管理互动
来源关键动作：Instagram account credentials；OpenClaw with browser capability enabled；A content calendar or list of topics
...
- [usecases/53-instagram-story-manager.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/53-instagram-story-manager.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「智能日历提醒」。

目标（来自来源案例）：带准备建议的上下文提醒
来源关键动作：Google Calendar or Outlook connected to OpenClaw；Telegram bot for notifications
优先工具/渠道：Telegram、Google Calendar、heartbeat、OpenClaw
来源节奏信息：every 30 minutes；Every 30 minutes
...
- [usecases/55-calendar-smart-reminder.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/55-calendar-smart-reminder.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「冷关系复活」。

目标（来自来源案例）：重新联系失去联系的朋友
来源关键动作：A messaging platform connected to OpenClaw (WhatsApp, Telegram, or Signal)；A list of contacts you'd like to stay in touch with
优先工具/渠道：Telegram、WhatsApp、cron、OpenClaw
来源节奏信息：源头未明确固定调度
...
- [usecases/54-cold-relationship-revival.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/54-cold-relationship-revival.md)

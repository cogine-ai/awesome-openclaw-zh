...
```text
你是我的 OpenClaw 助手，现在执行案例「会议纪要生成」。

目标（来自来源案例）：粘贴原始笔记获取结构化纪要
来源关键动作：Telegram or Signal connected to OpenClaw；Raw meeting notes or transcript (from Otter.ai, Zoom transcript, or your own notes)
...
- [usecases/68-meeting-notes-generator.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/68-meeting-notes-generator.md)

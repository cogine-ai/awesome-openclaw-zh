...
```text
你是我的 OpenClaw 助手，现在执行案例「Telegram 智能家居」。

目标（来自来源案例）：聊天控制灯光温度门锁
来源关键动作：Home Assistant (or similar) running on your network；Home Assistant API token；Telegram bot connected to OpenClaw
优先工具/渠道：Telegram、heartbeat、OpenClaw
来源节奏信息：every 5 minutes
...
- [usecases/62-smart-home-telegram.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/62-smart-home-telegram.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「购物比价助手」。

目标（来自来源案例）：多平台找最优价格
来源关键动作：Telegram bot connected to OpenClaw；Your country/region for relevant stores
...
- [usecases/67-price-comparison-shopper.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/67-price-comparison-shopper.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「Trello/Notion 整理」。

目标（来自来源案例）：夜间清理看板晨间状态报告
来源关键动作：Trello or Notion account；Trello API key (or Notion integration token)；Telegram bot for notifications
优先工具/渠道：Telegram、Notion、cron
来源节奏信息：源头未明确固定调度
...
- [usecases/66-trello-notion-organizer.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/66-trello-notion-organizer.md)

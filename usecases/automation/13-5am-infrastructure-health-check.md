...
```text
你是我的 OpenClaw 助手，现在执行案例「凌晨 5 点基础设施健康检查」。

目标（来自来源案例）：工作日前的服务器监控
来源关键动作：# 5AM Infrastructure Health Check；## Introduction；Early morning server health monitoring: uptime checks, disk space verification, resource utilization tracking, and backup validation. Proactive identification of issues before human starts workday.
优先工具/渠道：system、telegram、cron、Telegram
来源节奏信息：05:00
...
- [usecases/13-5am-infrastructure-health-check.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/13-5am-infrastructure-health-check.md)

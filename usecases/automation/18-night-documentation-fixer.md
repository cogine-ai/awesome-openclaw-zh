...
```text
你是我的 OpenClaw 助手，现在执行案例「夜间文档修复器」。

目标（来自来源案例）：错别字和 README 改进
来源关键动作：# Night Documentation Fixer；## Introduction；Automated typo correction and README improvement during night hours. Scans documentation for spelling errors, broken links, and outdated sections, submits fixes as PRs.
优先工具/渠道：git、filesystem
来源节奏信息：源头未明确固定调度
...
- [usecases/18-night-documentation-fixer.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/18-night-documentation-fixer.md)

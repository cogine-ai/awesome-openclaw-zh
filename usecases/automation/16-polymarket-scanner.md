...
```text
你是我的 OpenClaw 助手，现在执行案例「Polymarket 扫描器」。

目标（来自来源案例）：预测市场监控
来源关键动作：# Polymarket Scanner；## Introduction；Automated prediction market monitoring: scans Polymarket every 15 minutes overnight, tracks positions, identifies opportunities, and prepares morning health report with P&L summary.
优先工具/渠道：polymarket、telegram、Telegram
来源节奏信息：every 15 minutes；Every 15 minutes
...
- [usecases/16-polymarket-scanner.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/16-polymarket-scanner.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「比特币铭文」。

目标（来自来源案例）：在链上创建永久网页
来源关键动作：# Bitcoin Inscription；## Introduction；Creating permanent web pages on Bitcoin blockchain using Ordinal inscriptions. While human sleeps, agent creates .web3 portfolio pages that exist forever without hosting fees or server maintenance.
优先工具/渠道：bitcoin、web
来源节奏信息：源头未明确固定调度
...
- [usecases/15-bitcoin-inscription.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/15-bitcoin-inscription.md)

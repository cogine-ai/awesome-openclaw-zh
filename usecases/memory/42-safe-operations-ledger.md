...
```text
你是我的 OpenClaw 助手，现在执行案例「安全操作分类账」。

目标（来自来源案例）：记录自主权限
来源关键动作：# Safe Operations Ledger；## Introduction；Documents all autonomous actions agent is permitted to run without human approval. Defines escalation rules for out-of-bounds requests.
优先工具/渠道：filesystem、heartbeat
来源节奏信息：源头未明确固定调度
...
- [usecases/42-safe-operations-ledger.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/42-safe-operations-ledger.md)

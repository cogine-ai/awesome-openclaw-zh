...
```text
你是我的 OpenClaw 助手，现在执行案例「早间摘要生成器」。

目标（来自来源案例）：编译夜间活动
来源关键动作：# Morning Digest Generator；## Introduction；Compiles overnight activity into consolidated morning briefing: what happened, what the agent did, what needs human attention.
优先工具/渠道：filesystem、telegram、Telegram、GitHub、cron
来源节奏信息：14:00；16:00；07:00
...
- [usecases/45-morning-digest-generator.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/45-morning-digest-generator.md)

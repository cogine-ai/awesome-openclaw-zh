...
```text
你是我的 OpenClaw 助手，现在执行案例「夜间工作 ROI 跟踪器」。

目标（来自来源案例）：跟踪自主工作的有效性
来源关键动作：# Night Work ROI Tracker；## Introduction；Tracks effectiveness of autonomous night work: what was built, what was used, what was reverted. Optimizes future work based on hit rate.
优先工具/渠道：filesystem、memory
来源节奏信息：源头未明确固定调度
...
- Log what was built
- Track if human uses it

## 参考来源

- [EvoLinkAI/awesome-openclaw-usecases-moltbook](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook)
- [usecases/48-night-work-roi-tracker.md](https://github.com/EvoLinkAI/awesome-openclaw-usecases-moltbook/blob/main/usecases/48-night-work-roi-tracker.md)

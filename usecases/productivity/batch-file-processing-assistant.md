...
```text
你是我的 OpenClaw 助手，现在执行案例「批量文件处理助手」。

目标（来自来源案例）：批量处理文档并生成摘要，适合资料密集型任务。
来源关键动作：SOURCE_DIR="$HOME/Documents/ToProcess"；OUTPUT_DIR="$HOME/Documents/Processed"；OPENCLAW_BIN="openclaw"
优先工具/渠道：OpenClaw
来源节奏信息：源头未明确固定调度
...
- [examples/automation/batch-process-files.sh](https://github.com/xianyu110/awesome-openclaw-tutorial/blob/main/examples/automation/batch-process-files.sh)

...
```text
你是我的 OpenClaw 助手，现在执行案例「个人 CRM」。

目标（来自来源案例）：自动从电子邮件和日历中发现并追踪联系人，支持自然语言查询。
来源关键动作：Create a CRM database:；CREATE TABLE contacts (；id INTEGER PRIMARY KEY,
优先工具/渠道：gog、Telegram、Google Calendar、Gmail、cron、OpenClaw
来源节奏信息：源头未明确固定调度
...
- [usecases/personal-crm.md](https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/main/usecases/personal-crm.md)

...
- Make sure your OpenClaw is connected to your preferred messaging platform (Telegram, Discord, etc.).
...
```text
你是我的 OpenClaw 助手，现在执行案例「第二大脑」。

目标（来自来源案例）：向机器人发送任何内容来记住它，然后在自定义的 Next.js 仪表板中搜索你的所有记忆。
来源关键动作：Text anything to your OpenClaw via Telegram, iMessage, or Discord — "Remind me to read a book about local LLMs" — and it remembers it instantly；OpenClaw's built-in memory system stores everything you tell it permanently；A custom Next.js dashboard lets you search through every memory, conversation, and note
优先工具/渠道：Telegram、Discord、Notion、GitHub、OpenClaw
来源节奏信息：源头未明确固定调度
...
- [usecases/second-brain.md](https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/main/usecases/second-brain.md)

...
```text
你是我的 OpenClaw 助手，现在执行案例「市场研究与产品工厂」。

目标（来自来源案例）：使用 Last 30 Days 技能从 Reddit 和 X 挖掘真实痛点，然后让 OpenClaw 构建解决它们的 MVP。
来源关键动作：Researches any topic across Reddit and X over the last 30 days using the [Last 30 Days](https://github.com/matvanhorde/last-30-days) skill；Surfaces real challenges, complaints, and feature requests people are posting about；Helps you identify product opportunities from genuine user pain points
优先工具/渠道：Telegram、Discord、GitHub、OpenClaw
来源节奏信息：源头未明确固定调度
...
- [usecases/market-research-product-factory.md](https://github.com/hesamsheikh/awesome-openclaw-usecases/blob/main/usecases/market-research-product-factory.md)
